...
FMDATA = {
    ...
    "Non_Quant": "Non_Quant",  # boolean denoting that a feature is not quantifiable
    "Skip_Pool_DC": "Skip_Pool_DC",  # boolean, used by blueshift to skip rows in pool correction
...
IMDATA = {
    "injection_id": "injection_id",  # injection name, usually filename
    "broad_id": "broad_id",  # internal biospecimen label
    "program_id": "program_id",  # external biospecimen label
    "injection_type": "injection_type",  # type of injection
    "notes": "notes",  # comments about the injection
    "column_number": "column_number",  # column number, relevant in multi-column studies
    "injection_order": "injection_order",  # injection number, not skipping blanks or non-samples
    "batches": "batches",  # 'batch_start' or 'batch_end'
